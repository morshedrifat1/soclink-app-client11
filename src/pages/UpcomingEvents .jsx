        ...
        {UpcomingEvents.map((event) => (
          <div className="bg-boxbg shadow rounded-lg relative group overflow-hidden">
            ...
            <div className="p-4 space-y-2.5">
              ...
              <Link to={`/event-details/${event._id}`} className="bg-gradient-to-br from-primary to-secondary rounded-lg w-full block text-center text-white text-base py-2 mt-3 cursor-pointer">
                View Event
              </Link>
            </div>
